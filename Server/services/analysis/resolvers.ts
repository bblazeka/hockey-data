  ...
  teams.forEach(function (team) {
    ...
    Object.assign(team, {
      ...
      stats: [
        ...
        {
          title: "L",
          value: team.statsSingleSeason.losses,
          description: "Losses",
        },
        {
          title: "OT",
          value: team.statsSingleSeason.ot,
          description: "Overtime losses",
        },
        {
          title: "PTS",
          value: team.statsSingleSeason.pts,
          description: "Points",
        },
        {
          title: "PTS%",
          value: team.statsSingleSeason.ptPctg,
          description: "Point percentage",
        },
        {
          title: "GFPG",
          value: team.statsSingleSeason.goalsPerGame,
          description: "Goals for per game",
        },
        {
          title: "GAPG",
          value: team.statsSingleSeason.goalsAgainstPerGame,
          description: "Goals against per game",
        },
        {
          title: "EGR",
          value: round(team.statsSingleSeason.evGGARatio, 2),
          description: "Even strength goals / goals against ratio",
        },
        {
          title: "PPGF",
          value: team.statsSingleSeason.powerPlayGoals,
          description: "Power play goals for",
        },
        {
          title: "PPGA",
          value: team.statsSingleSeason.powerPlayGoalsAgainst,
          description: "Power play goals against",
        },
        {
          title: "PPO",
          value: team.statsSingleSeason.powerPlayOpportunities,
          description: "Power play opportunities",
        },
        {
          title: "PP%",
          value: team.statsSingleSeason.powerPlayPercentage,
          description: "Power play percentage",
        },
        {
          title: "PK%",
          value: team.statsSingleSeason.penaltyKillPercentage,
          description: "Penalty kill percentage",
        },
        {
          title: "SFPG",
          value: round(team.statsSingleSeason.shotsPerGame, 2),
          description: "Shots on goal per game",
        },
        {
          title: "SAPG",
          value: round(team.statsSingleSeason.shotsAllowed, 2),
          description: "Shots on goal allowed per game",
        },
        {
          title: "WSF",
          value: team.statsSingleSeason.winScoreFirst,
          description: "Wins score first",
        },
        {
          title: "WOSF",
          value: team.statsSingleSeason.winOppScoreFirst,
          description: "Wins opponent scores first",
        },
        {
          title: "WL1",
          value: team.statsSingleSeason.winLeadFirstPer,
          description: "Wins after leading in 1st period",
        },
        {
          title: "WL2",
          value: team.statsSingleSeason.winLeadSecondPer,
          description: "Wins after leading in 2nd period",
        },
        {
          title: "WOS",
          value: team.statsSingleSeason.winOutshootOpp,
          description: "Wins after outshooting the opposition",
        },
        {
          title: "WOP",
          value: team.statsSingleSeason.winOutshotByOpp,
          description: "Wins after being outshot by opponent",
        },
        {
          title: "FO",
          value: team.statsSingleSeason.faceOffsTaken,
          description: "Faceoffs taken",
        },
        {
          title: "FOW",
          value: team.statsSingleSeason.faceOffsWon,
          description: "Faceoffs won",
        },
        {
          title: "FOL",
          value: team.statsSingleSeason.faceOffsLost,
          description: "Faceoffs lost",
        },
        {
          title: "FO%",
          value: team.statsSingleSeason.faceOffWinPercentage,
          description: "Faceoff win percentage",
        },
        {
          title: "S%",
          value: team.statsSingleSeason.shootingPctg,
          description: "Shooting percentage",
        },
        {
          title: "SVS%",
          value: team.statsSingleSeason.savePctg,
