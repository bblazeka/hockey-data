...
export default function Standings() {
  ...
  const { standings, locations } = useSelector(state => ({
                  ...
                  {entry.teamRecords.map((record) => {
                    return (
                      <Table.Row key={`row${record.team.id}`}>
                        <Table.Cell className="bigger-text bold">{record.divisionRank}</Table.Cell>
                        <Table.Cell>
                        ...
                        <Table.Cell className="bold">{record.points}</Table.Cell>
                      </Table.Row>
                    );
                  })}
                </Table.Body>
